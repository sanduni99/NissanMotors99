...
<?php  
    ...
    if(isset($_POST['btnSubmit'])) {
        if(validateTextField()){
            ...
            VALUES ('".$itemNo."', '".$date."', '".$_POST['txtDistrict']."', '".$_POST['txtCondition']."', '".$_POST['txtBrand']."', '".$_POST['txtYear']."', '".$_POST['txtModel']."', '".$_POST['txtCapacity']."', '".$_POST['txtFuel']."', '".$_POST['txtDisc']."', '".$_SESSION['userID']."', '".$_POST['txtPrice']."','Posted');";
            if (mysqli_query($conn, $sql2)) {
                if (count($_FILES) > 0) {
                    if (validateImages()) {
                        ...
                        $sql3 = "INSERT INTO postimage(addID ,image1, image2, image3, image4, image5) VALUES('{$itemNo}', '{$img1}', '{$img2}' , '{$img3}' , '{$img4}', '{$img5}')";
                        ...
                        echo '<script>window.alert("File error 2")</script>';
                    }
                }
                else{
                    echo '<script>window.alert("File error 1")</script>';
                }
